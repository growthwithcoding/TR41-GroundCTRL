...
const CALLSIGN_PREFIXES = [
  "Maverick", "Viper", "Iceman", "Goose", "Jester", "Merlin", "Cougar",
  "Apollo", "Gemini", "Mercury", "Orion", "Artemis", "Voyager", "Pioneer",
  "Starlink", "Falcon", "Dragon", "Endeavor", "Discovery", "Atlantis",
  "Nebula", "Pulsar", "Quasar", "Comet", "Meteor", "Nova", "Cosmos",
  "Orbit", "Vector", "Zenith", "Apogee", "Eclipse", "Phoenix", "Titan"
]

const CALLSIGN_SUFFIXES = [
  "One", "Alpha", "Prime", "Ace", "Six", "Seven", "X", "Blue", "Red",
  "Ghost", "Thunder", "Lightning", "Storm", "Hawk", "Eagle", "Wolf"
]
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Your pilot callsign for missions (e.g., MaverickOne, StarlinkAce)
              </p>
            </div>
          </>
        )}
        ...
        <div className="text-center text-sm text-muted-foreground">
          {isLogin ? (
            <>
              ...
              <button type="button" onClick={() => onViewChange("register")} className="text-primary hover:underline font-medium">
                Register
              </button>
            </>
          ) : (
            <>
              ...
              <button type="button" onClick={() => onViewChange("login")} className="text-primary hover:underline font-medium">
                Sign In
              </button>
            </>
          )}
