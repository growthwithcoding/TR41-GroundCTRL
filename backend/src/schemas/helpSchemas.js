	...
	.object({
		body: z
			.object({
				...
				isPinned: z.boolean().default(false).describe("Pin to top of category"),
	...
	.object({
		query: z
			.object({
				...
				tag: z.string().max(50).optional().describe("Filter by tag"),
			})
			.strict(),
	})
	.strict();
	...
	.object({
		body: z
			.object({
				...
				relatedArticleIds: z.array(z.string()).max(3).optional(),
			})
			.strict(),
	})
	.strict();
	...
	.object({
		body: z
			.object({
				...
				suggestedCorrection: z.string().max(5000).trim().optional(),
			})
			.strict(),
	})
	.strict();
