...
const tutorialPreferencesSchema = z
	.object({
...
const renderingPreferencesSchema = z
	.object({
...
const createUserSchema = z
	.object({
		...
		displayName: z
			...
			.optional(),
		role: z.enum(["operator", "admin", "viewer"]).default("operator"),
...
const patchUserSchema = z
	.object({
		...
		displayName: z
			...
			.max(50, "Display name must not exceed 50 characters")
			.optional(),
		role: z.enum(["operator", "admin", "viewer"]).optional(),
...
const userQuerySchema = z
	.object({
		...
		sortBy: z
			.enum(["createdAt", "email", "callSign", "displayName"])
			.optional(),
